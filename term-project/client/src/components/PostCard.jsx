                ...
                <div className=''>
                    <Link to={'/profile/'+ post?.userId?._id}>
                        <p className='font-medium text-lg text-ascent-1'>
                            {post?.userId?.firstName} {post?.userId?.lastName}</p>
                    </Link>
                                ...
                                <div className='w-full py-2 ' key={comment?._id}>
                                    ...
                                    <div  className='ml-12 '>
                                        ...
                                        </div>
                                        {
                                            replyComments === comment?._id && (
                                                ...
                                                user={user}
                                                id={post?._id}
                                                replyAt={comment?.userId?.firstName}
                                                getComments={()=>getComments(post?._id)}
                                                />
                                            )
                                        }
                                    ...
                                    <div className='py-2 px-8 mt-6'>
                                        {comment?.replies?.length > 0 && (
                                            <p
                                            className='text-ascent-1 text-base cursor-pointer'
                                            onClick={() => {
                                                const replyId = comment && comment.replies && comment.replies[0] && comment.replies[0].commentId;
                                                setShowReply((showReply===comment?.replies?._id ? 0 : comment?.replies?._id));
                                              }}>
